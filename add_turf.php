...
$turf_nameerr = $turf_iderr = $addresserr = $locationerr = $emailerr = $mobileerr = $passworderr = $user_roleerr = $post_imgerr = '';

$turf_name = $turf_id = $address = $location = $email = $mobile = $password = $user_role = $post_img = '';
                        ...
                        <form role="form" id="quickForm" method="post" action="" enctype="multipart/form-data">
                            <div class="card-body">
                                <div class="row">
                                    ...
                                    <div class="col-lg-6">
                                        <div class="form-group">
                                            <label for="location">Location <span class="error"><?php echo '  ' . $locationerr ?></span></label>
                                            <select class="form-control" name="location">
                                                ...
                                                try {
                                                    ...
                                                    // Get the previously selected location
                                                    $selectedLocation = isset($_POST['location']) ? $_POST['location'] : '';

                                                    while ($location = mysqli_fetch_array($locationdata)) {
                                                ?>
                                                        <option value="<?php echo $location['location_name']; ?>" <?php echo ($location['location_name'] == $selectedLocation) ? 'selected' : ''; ?>>
